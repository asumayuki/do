...
const proxyIPs = ["146.190.6.239"]; // ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
...
一、VLESS Websocket Over WARP (TLS)：
${pvlesswstls}

---------------------------------------------------------------
#Informasi Akun# VLESS Over WARP
---------------------------------------------------------------
address ：(Alamat IP/host/proxy/domain)
Domain : ${hostName}
Port HTTP： (8080、8880、2052、2082、2086、2095)
